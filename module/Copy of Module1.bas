...
Form=forms\filter.frm
Form=forms\frmsec.frm
Form=forms\frmfees.frm
Form=forms\frmthird.frm
Form=forms\frmfeemft.frm
Form=forms\frmupdate.frm
Form=forms\frminstalpay.frm
Form=forms\MDIForm1.frm
Form=forms\frmLogin.frm
Module=Module1; module\Module1.bas
Designer=Re